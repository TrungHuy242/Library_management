...
(1, 'Nguyễn Văn An', 'D21CQCN01', '0905000111', 'an@student.com', '2003-05-15', '2025-11-29'),
(2, 'Trần Thị Bình', 'D21CQCN02', '0905000222', 'binh@student.com', '2003-07-20', '2025-11-29'),
...
(3, 'Từ Nguyễn Huyền Trang', '0909333444', 'Thủ thư', 'huyentrang', 'trang123');
...
(1, 1, 1, '2025-11-20', '2025-12-04', 'Đang mượn'),
(2, 2, 1, '2025-11-10', '2025-11-24', 'Quá hạn'),
(3, 3, 2, '2025-10-25', '2025-11-08', 'Đã trả'),
(4, 4, 1, '2025-10-15', '2025-11-05', 'Quá hạn'),
(5, 5, 2, '2025-11-01', '2025-11-15', 'Đã trả'),
(6, 6, 1, '2025-11-28', '2025-12-12', 'Đang mượn'),
(7, 1, 2, '2025-11-15', '2025-11-29', 'Quá hạn'),
(8, 7, 1, '2025-11-05', '2025-11-19', 'Quá hạn'),
(9, 8, 2, '2025-11-25', '2025-12-09', 'Đang mượn'),
(10, 3, 1, '2025-11-18', '2025-12-02', 'Đang mượn');
...
(1, 'Lập Trình Java Cơ Bản', 2, 1, '2023', 'NXB Giáo Dục', 20, 15, 'Bình thường'),
(2, 'Java Nâng Cao', 4, 1, '2022', 'NXB Kim Đồng', 15, 10, 'Bình thường'),
(3, 'Cấu Trúc Dữ Liệu & Giải Thuật', 3, 1, '2021', 'NXB Khoa Học', 25, 18, 'Bình thường'),
(4, 'Cơ Sở Dữ Liệu', 3, 2, '2020', 'NXB Đại Học Quốc Gia', 30, 25, 'Bình thường'),
(5, 'Toán Rời Rạc', 3, 3, '2024', 'NXB Giáo Dục', 40, 35, 'Bình thường'),
(6, 'Mắt Biếc', 5, 4, '2019', 'NXB Trẻ', 50, 45, 'Bình thường'),
(7, 'Dế Mèn Phiêu Lưu Ký', 6, 4, '1941', 'NXB Văn Học', 60, 58, 'Bình thường'),
(8, 'Chí Phèo', 7, 4, '1941', 'NXB Văn Học', 35, 35, 'Bình thường'),
(9, 'C++ Programming', 1, 1, '2018', 'NXB Giáo Dục', 18, 12, 'Bình thường'),
(10, 'Lập Trình Hướng Đối Tượng', 4, 1, '2023', 'NXB Kim Đồng', 22, 8, 'Bình thường'),
(11, 'Trung hẹ hẹ', 5, 3, '2025', 'Hoainhi', 12, 12, 'Bình thường');
...
--
ALTER TABLE `bandoc`
  MODIFY `maBanDoc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `tacgia`
  MODIFY `maTacGia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
