...
public class SuaTacGia extends JDialog {
    ...
    public SuaTacGia(int maTacGia, QuanLyTacGia parent) {
        super(parent, "SỬA THÔNG TIN TÁC GIẢ", true);
    ...
    private void initGUI() {
        ...
        JLabel lblTitle = new JLabel("SỬA THÔNG TIN TÁC GIẢ", SwingConstants.LEFT);
        ...
        JLabel lblMaValue = new JLabel(String.valueOf(maTacGia));
