...
public class SuaDocGia extends JDialog {

    private JTextField txtHoTen, txtLop, txtSdt, txtEmail, txtNgaySinh;
    private JLabel lblErrorHoTen, lblErrorSdt, lblErrorEmail, lblErrorNgaySinh;
    private int maBanDoc;
    private QuanLyDocGia parent;

    public SuaDocGia(int maBanDoc, QuanLyDocGia parent) {
        super(parent, "SỬA THÔNG TIN ĐỘC GIẢ", true);
    ...
    private void initGUI() {
        ...
        JLabel lblTitle = new JLabel("SỬA THÔNG TIN ĐỘC GIẢ", SwingConstants.LEFT);
    ...
    private void loadDuLieuHienTai() {
        ...
        if (bd != null) {
            ...
            txtSdt.setText(bd.getSdt() != null ? bd.getSdt() : "");
            txtEmail.setText(bd.getEmail() != null ? bd.getEmail() : "");
            if (bd.getNgaySinh() != null) {
                txtNgaySinh.setText(bd.getNgaySinh().toString());
            }
        }
    }
